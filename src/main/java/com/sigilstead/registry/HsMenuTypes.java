...
public final class HsMenuTypes {
    ...
    public static final MenuType<VaultMenu> VAULT = Registry.register(
            ...
            ResourceKey.create(Registries.MENU, Sigilstead.id("vault")),
    ...
    public static final MenuType<CodexMenu> CODEX = Registry.register(
            BuiltInRegistries.MENU,
            ResourceKey.create(Registries.MENU, Sigilstead.id("codex")),
    ...
    public static final MenuType<CoreHousingMenu> CORE_HOUSING = Registry.register(
            BuiltInRegistries.MENU,
            ResourceKey.create(Registries.MENU, Sigilstead.id("core_housing")),
