...
import com.sigilstead.block.CodexBlock;
import com.sigilstead.block.CoreHousingBlock;
import com.sigilstead.block.LinkedFunnelBlock;
import com.sigilstead.block.VaultAnchorBlock;
import com.sigilstead.core.CoreFamily;
import com.sigilstead.item.VaultAnchorBlockItem;
...
public final class HsBlocks {
    ...
    private static Block register(
        ...
        ResourceKey<Block> blockKey = ResourceKey.create(Registries.BLOCK, Sigilstead.id(path));
        Block block = Registry.register(BuiltInRegistries.BLOCK, blockKey, blockFactory.apply(blockKey));
        ResourceKey<Item> itemKey = ResourceKey.create(Registries.ITEM, Sigilstead.id(path));
