 ...
 *
 * <p>Carries the {@link com.sigilstead.vault.VaultUpgradeKind} ordinal, not the sigil count or the
...
public record VaultConfirmUpgradePayload(int kind) implements CustomPacketPayload {
    ...
    public static final Type<VaultConfirmUpgradePayload> TYPE = new Type<>(Sigilstead.id("vault_confirm_upgrade"));
