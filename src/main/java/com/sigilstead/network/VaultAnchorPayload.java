 ...
 *
 * <p>Without this, {@link com.sigilstead.block.VaultAnchorBlock#canSurvive} can only refuse on the
...
public record VaultAnchorPayload(Optional<BlockPos> anchorPos) implements CustomPacketPayload {
    ...
    public static final Type<VaultAnchorPayload> TYPE = new Type<>(Sigilstead.id("vault_anchor"));
