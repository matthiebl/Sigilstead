 ...
 * mob's", so the Ender Core rolls its own bespoke {@code sigilstead:classic_cores/ender} table
 * ({@link com.sigilstead.core.ClassicCore}) rather than a real enderman's. This dragon death only
