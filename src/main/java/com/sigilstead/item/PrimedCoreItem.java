...
import com.sigilstead.core.CoreTargets;
 ...
 * Carried while you play until it reaches its threshold, at which point {@link com.sigilstead.core.CoreImprint}
...
public class PrimedCoreItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        if (attunement.unattuned()) {
            lines.accept(Component.translatable("item.sigilstead.core.unattuned." + family.id())
                    .withStyle(ChatFormatting.GRAY));
            lines.accept(Component.translatable("item.sigilstead.core.hand_only")
                    .withStyle(ChatFormatting.DARK_GRAY));
            return;
        }

        Identifier lockedTarget = attunement.target().orElseThrow();
        int threshold = com.sigilstead.core.ClassicCore.forTarget(lockedTarget)
        ...
        lines.accept(Component.translatable("item.sigilstead.core.attuning", target,
                attunement.progress(), threshold).withStyle(ChatFormatting.AQUA));
        lines.accept(Component.translatable("item.sigilstead.core.yield",
