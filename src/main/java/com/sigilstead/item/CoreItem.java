...
public class CoreItem extends Item {
    ...
    public Component getName(ItemStack stack) {
        ...
        return Component.translatable("item.sigilstead.core.named", super.getName(stack),
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        lines.accept(Component.translatable("item.sigilstead.core.tier", tier.level())
                .withStyle(ChatFormatting.GOLD));

        CoreTier next = tier.next();
        if (next == null) {
            lines.accept(Component.translatable("item.sigilstead.core.tier_max")
                    .withStyle(ChatFormatting.DARK_GRAY));
        } else {
            lines.accept(Component.translatable("item.sigilstead.core.tier_next", next.costDescription())
                    .withStyle(ChatFormatting.DARK_GRAY));
        }

        attunement.target().ifPresent(target -> lines.accept(Component.translatable("item.sigilstead.core.yield",
