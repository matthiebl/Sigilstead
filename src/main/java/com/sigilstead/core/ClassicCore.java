 ...
 * {@code sigilstead:} target rather than the real mob they are thematically about. That is
 * deliberate: overrides in {@link com.sigilstead.config.ClassicCoreConfig} and
...
public enum ClassicCore {
    ...
    OMINOUS("ominous", CoreFamily.SOUL, "sigilstead:ominous"),
    BARTER("barter", CoreFamily.SOUL, "sigilstead:barter"),
    GUARDIAN("guardian", CoreFamily.SOUL, "sigilstead:guardian"),
    TIDAL("tidal", CoreFamily.SOUL, "minecraft:drowned"),
    WITHER_SKULL("wither_skull", CoreFamily.SOUL, "sigilstead:wither_skull"),
    ENDER("ender", CoreFamily.SOUL, "sigilstead:ender"),
    SHULKER("shulker", CoreFamily.SOUL, "sigilstead:shulker"),
    ...
    ClassicCore(String id, CoreFamily family, String target) {
        ...
        this.lootTable = ResourceKey.create(Registries.LOOT_TABLE, Sigilstead.id("classic_cores/" + id));
    }
    ...
    /** True for the six milestone-shaped entries, whose target only {@code sigilstead} code ever locks. */
    public boolean isSynthetic() {
        return target.getNamespace().equals(Sigilstead.MOD_ID);
    }

    /** §5's "the finished core, named for what it learned" line, for the synthetic six. */
    public Component displayName() {
        return Component.translatable("sigilstead.classic_core." + id);
    }
    ...
    public Component yieldDescription() {
        return Component.translatable("sigilstead.classic_core." + id + ".yield");
    }
