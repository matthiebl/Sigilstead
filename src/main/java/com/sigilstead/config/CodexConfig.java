 ...
 * to tune, so {@link com.sigilstead.codex.CodexArchiveTier} hardcodes it rather than reading a config
 ...
 * {@link com.sigilstead.codex.Codex#priceFor} falls back to {@code formulaEmeraldsPerRarityLevel} ×
