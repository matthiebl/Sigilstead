 ...
 * (CONVENTIONS.md §5), so they live in {@link com.heartstead.config.AttunementConfig} and
 * {@link com.heartstead.config.CoreConfig} rather than as literals on an enum constant.
 *
