 ...
 * {@code data/heartstead/enchantment/}), not Java-registered objects, so there is nothing to
...
public final class HsEnchantments {
    ...
    public static final ResourceKey<Enchantment> ABUNDANCE =
            ResourceKey.create(Registries.ENCHANTMENT, Heartstead.id("abundance"));
    public static final ResourceKey<Enchantment> KILN_TOUCH =
            ResourceKey.create(Registries.ENCHANTMENT, Heartstead.id("kiln_touch"));
