...
public enum VaultUpgradeKind implements StringRepresentable {
    ...
    /** Only used by DESIGN.md §7.3's {@code heartstead:vault_upgraded} criterion, which names a slot. */
    ...
    public String translationKey() {
        return "gui.heartstead.vault.upgrade." + name().toLowerCase(java.util.Locale.ROOT);
    }
}
